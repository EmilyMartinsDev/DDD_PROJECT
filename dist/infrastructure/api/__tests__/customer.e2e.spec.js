...
describe("E2E test for customer", () => {
    ...
    it("should not create a customer", async () => {
        const response = await (0, supertest_1.default)(express_1.app).post("/customer").send({
            name: "john",
        });
    ...
    it("should list all customer", async () => {
        ...
        expect(response.status).toBe(200);
        const response2 = await (0, supertest_1.default)(express_1.app)
            .post("/customer")
            .send({
            name: "Jane",
            address: {
        ...
        const listResponse = await (0, supertest_1.default)(express_1.app).get("/customer").send();
