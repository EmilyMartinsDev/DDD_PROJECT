...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => require("../../customer/sequelize/customer.model").CustomerModel),
    (0, sequelize_typescript_1.Column)({ allowNull: false }),
    __metadata("design:type", String)
], OrderModel.prototype, "customer_id", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => require("../../customer/sequelize/customer.model").CustomerModel),
    __metadata("design:type", customer_model_1.CustomerModel)
], OrderModel.prototype, "customer", void 0);
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => require("./order-item.model").default),
